        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "character varying(201)", maxLength: 201, nullable: false, computedColumnSql: "\"Resource\" || '.' || \"Action\"", stored: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAuditLogs_Action_PerformedAt",
                table: "PermissionAuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAuditLogs_PermissionId_PerformedAt",
                table: "PermissionAuditLogs",
                columns: new[] { "PermissionId", "PerformedAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PermissionAuditLogs_UserId_PerformedAt",
                table: "PermissionAuditLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_Action_IsActive",
                table: "Permissions",
                columns: new[] { "Action", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_Category_IsActive",
                table: "Permissions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Permissions_Resource_IsActive",
                table: "Permissions",
                columns: new[] { "Resource", "IsActive" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPermissions_UserId_State_ExpiresAt",
                table: "UserPermissions",
